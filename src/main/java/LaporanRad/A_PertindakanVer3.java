...
//
//public class A_PertindakanVer3 extends StylerRepo{
//    public static void main(String[] args) {
//        new A_PertindakanVer3 ();
//
//    }
...
//            AreaReference dataRange = new AreaReference ("A1:AE2747", SpreadsheetVersion.EXCEL2007);
//
////          Create the pivot table
//            XSSFPivotTable pivotTable = Tindakan_crByr_Hari.createPivotTable(dataRange, new CellReference ("A1"));
//
////          Set the rows and columns for the pivot table
//            pivotTable.addRowLabel(1); // Taggal in rows
//            pivotTable.addColumnLabel(DataConsolidateFunction.COUNT, 2); // noreg in values
//            pivotTable.addColumnLabel(DataConsolidateFunction.SUM, 3); // tindakan in columns
//            pivotTable.addColumnLabel(DataConsolidateFunction.SUM, 4); // Cara bayar in columns
//
////           Set the table style
//            pivotTable.getCTPivotTableDefinition().setTableStyleInfo(
//                    CTTableStyleInfo.Factory.newInstance());
//
//
//
//
